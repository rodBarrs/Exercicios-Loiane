...
public class Exercicio07 {
    public static void main(String[] args) {
        ...
        if ((numero1 <= numero2) && (numero1 <= numero3)) {
            JOptionPane.showMessageDialog(null,"Numero 1 menor! " + numero1);
        } else if ((numero2 <= numero3) && (numero2 <= numero1)){
            JOptionPane.showMessageDialog(null,"Numero 2 menor! " + numero2);
        } else {
            JOptionPane.showMessageDialog(null,"Numero 3 menor! " + numero3);
        }
